package com.techafresh.jetreader.screens
...
fun SplashScreen(navController: NavController){
    ...
    LaunchedEffect(key1 = true){
        ...
        if (FirebaseAuth.getInstance().currentUser?.email.isNullOrEmpty()) navController.navigate(AppScreens.LoginScreen.name)
        else navController.navigate(AppScreens.HomeScreen.name)
    }
